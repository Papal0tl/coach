...
- **Self-catching bugs before reporting done**: Sessions 1, 4, 5, 6, and 7 all had bugs not self-caught. Session 7: cascade-corruption, variable swap, range error — none caught before reporting. 5 of 7 sessions. Consistent "submit early and rely on feedback" habit. Not a knowledge gap; the user catches bugs immediately once traced. Intervention overdue: next session, before giving any feedback, ask the user to trace a concrete example themselves.
...
- Self-catching bugs — 5 of 7 sessions. Intervention is now overdue. Next session: before giving any feedback, ask the user to trace a concrete example themselves on their own first attempt.
- Invariant articulation — LC 73 blog correctness argument was the clearest yet in a blog section (iff stated correctly, not just mechanics). Gap between chat and writing appears to be closing. One more session will confirm trend.
