...
User stated the invariant precisely without prompting further: "nums[i] represents the maximum subarray sum ending exactly at index i." Blog accepted after one revision (missing pattern-recognition section). Session closed.
